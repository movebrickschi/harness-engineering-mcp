...
.harness/engineering-harness.md                     项目内 SSOT（≤ 200 行精简版）
.harness/adr/0001-engineering-harness-baseline.md  首条 ADR
.github/pull_request_template.md                PR 模板（开源/多机协作时启用）
scripts/engineering-check.{ps1|sh}              本地门禁
.harness/baseline.json                      质量基线
